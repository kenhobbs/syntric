<?php
	...
	function syn_enqueue_scripts() {
		...
		// Google Fonts
		wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Roboto|Ubantu+Mono|Ubantu|Itim', null, null, null );
		...
		wp_register_script( 'jsdelivr', 'https://cdn.jsdelivr.net/combine/npm/jquery@3.2.1,npm/bootstrap@4.0.0-beta.2/dist/js/bootstrap.bundle.min.js,npm/moment@2.19.4,npm/fullcalendar@3.7.0,npm/chart.js@2.7.1/dist/Chart.min.js,npm/scroll-js@1.8.8/dist/scroll-min.min.js', null, null, true );
