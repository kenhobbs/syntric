...
axs.constants.ARIA_ROLES = {
	...
	button: {childpresentational: !0, namefrom: ['contents', 'author'], namerequired: !0, parent: ['command'], properties: ['aria-expanded', 'aria-pressed']},
	checkbox: {
		namefrom: ['contents',
			'author'], namerequired: !0, parent: ['input'], requiredProperties: ['aria-checked'], properties: ['aria-checked']
	},
	columnheader: {namefrom: ['contents', 'author'], namerequired: !0, parent: ['gridcell', 'sectionhead', 'widget'], properties: ['aria-sort']},
	combobox: {mustcontain: ['listbox', 'textbox'], namefrom: ['author'], namerequired: !0, parent: ['select'], requiredProperties: ['aria-expanded'], properties: ['aria-expanded', 'aria-autocomplete', 'aria-required']},
	command: {
		'abstract': !0, namefrom: ['author'],
		parent: ['widget']
	},
	complementary: {namefrom: ['author'], parent: ['landmark']},
	composite: {'abstract': !0, childpresentational: !1, namefrom: ['author'], parent: ['widget'], properties: ['aria-activedescendant']},
	...
	grid: {mustcontain: ['row', 'rowgroup'], namefrom: ['author'], namerequired: !0, parent: ['composite', 'region'], properties: ['aria-level', 'aria-multiselectable', 'aria-readonly']},
	gridcell: {namefrom: ['contents', 'author'], namerequired: !0, parent: ['section', 'widget'], properties: ['aria-readonly', 'aria-required', 'aria-selected']},
	...
	menu: {mustcontain: ['group', 'menuitemradio', 'menuitem', 'menuitemcheckbox'], namefrom: ['author'], namerequired: !0, parent: ['list', 'select']},
	...
	range: {'abstract': !0, namefrom: ['author'], parent: ['widget'], properties: ['aria-valuemax', 'aria-valuemin', 'aria-valuenow', 'aria-valuetext']},
	region: {namefrom: [' author'], parent: ['section']},
	roletype: {'abstract': !0, properties: 'aria-atomic aria-busy aria-controls aria-describedby aria-disabled aria-dropeffect aria-flowto aria-grabbed aria-haspopup aria-hidden aria-invalid aria-label aria-labelledby aria-live aria-owns aria-relevant'.split(' ')},
	row: {mustcontain: ['columnheader', 'gridcell', 'rowheader'], namefrom: ['contents', 'author'], parent: ['group', 'widget'], properties: ['aria-level', 'aria-selected']},
	rowgroup: {mustcontain: ['row'], namefrom: ['contents', 'author'], parent: ['group']},
	rowheader: {namefrom: ['contents', 'author'], namerequired: !0, parent: ['gridcell', 'sectionhead', 'widget'], properties: ['aria-sort']},
	search: {namefrom: ['author'], parent: ['landmark']},
	section: {
		'abstract': !0, namefrom: ['contents', 'author'], parent: ['structure'],
		properties: ['aria-expanded']
	},
	...
	separator: {childpresentational: !0, namefrom: ['author'], parent: ['structure'], properties: ['aria-expanded', 'aria-orientation']},
	scrollbar: {
		childpresentational: !0, namefrom: ['author'], namerequired: !1, parent: ['input', 'range'], requiredProperties: ['aria-controls', 'aria-orientation',
			'aria-valuemax', 'aria-valuemin', 'aria-valuenow'], properties: ['aria-controls', 'aria-orientation', 'aria-valuemax', 'aria-valuemin', 'aria-valuenow']
	},
	slider: {childpresentational: !0, namefrom: ['author'], namerequired: !0, parent: ['input', 'range'], requiredProperties: ['aria-valuemax', 'aria-valuemin', 'aria-valuenow'], properties: ['aria-valuemax', 'aria-valuemin', 'aria-valuenow', 'aria-orientation']},
	spinbutton: {
		namefrom: ['author'], namerequired: !0, parent: ['input', 'range'], requiredProperties: ['aria-valuemax',
			'aria-valuemin', 'aria-valuenow'], properties: ['aria-valuemax', 'aria-valuemin', 'aria-valuenow', 'aria-required']
	},
	...
	tablist: {mustcontain: ['tab'], namefrom: ['author'], parent: ['composite', 'directory'], properties: ['aria-level']},
	tabpanel: {namefrom: ['author'], namerequired: !0, parent: ['region']},
	textbox: {
		namefrom: ['author'],
		namerequired: !0, parent: ['input'], properties: ['aria-activedescendant', 'aria-autocomplete', 'aria-multiline', 'aria-readonly', 'aria-required']
	},
	...
	tree: {mustcontain: ['group', 'treeitem'], namefrom: ['author'], namerequired: !0, parent: ['select'], properties: ['aria-multiselectable', 'aria-required']},
	treegrid: {
...
axs.constants.ARIA_PROPERTIES = {
	...
	autocomplete: {defaultValue: 'none', type: 'property', valueType: 'token', values: ['inline', 'list', 'both', 'none']},
	busy: {defaultValue: 'false', type: 'state', valueType: 'boolean'},
	checked: {defaultValue: 'undefined', type: 'state', valueType: 'token', values: ['true', 'false', 'mixed', 'undefined']},
	...
	dropeffect: {defaultValue: 'none', type: 'property', valueType: 'token_list', values: 'copy move link execute popup none'.split(' ')},
	...
	invalid: {defaultValue: 'false', type: 'state', valueType: 'token', values: ['grammar', 'false', 'spelling', 'true']},
	...
	pressed: {defaultValue: 'undefined', type: 'state', valueType: 'token', values: ['true', 'false', 'mixed', 'undefined']},
	readonly: {
		defaultValue: 'false',
		type: 'property', valueType: 'boolean'
	},
	relevant: {defaultValue: 'additions text', type: 'property', valueType: 'token_list', values: ['additions', 'removals', 'text', 'all']},
...
}, {name: 'aria-multiline', values: {'true': 'aria_multiline_true'}}, {name: 'aria-multiselectable', values: {'true': 'aria_multiselectable_true'}}, {name: 'aria-pressed', values: {'true': 'aria_pressed_true', 'false': 'aria_pressed_false', mixed: 'aria_pressed_mixed'}}, {name: 'aria-readonly', values: {'true': 'aria_readonly_true'}}, {
	name: 'aria-required',
...
axs.AuditRule.specs.audioWithoutControls = {
	name: 'audioWithoutControls', heading: 'Audio elements should have controls', url: '', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.badAriaAttributeValue = {
	name: 'badAriaAttributeValue', heading: 'ARIA state and property values must be valid', url: '', severity: axs.constants.Severity.SEVERE, relevantElementMatcher: function (a) {
		var b = '', c;
...
axs.AuditRule.specs.controlsWithoutLabel = {
	name: 'controlsWithoutLabel', heading: 'Controls and media elements should have labels', url: 'https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#-ax_text_01--controls-and-media-elements-should-have-labels', severity: axs.constants.Severity.SEVERE, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.linkWithUnclearPurpose = {
	name: 'linkWithUnclearPurpose', heading: 'The purpose of each link should be clear from the link text', url: '', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.lowContrastElements = {
	name: 'lowContrastElements', heading: 'Text elements should have a reasonable contrast ratio', url: 'https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#-ax_color_01--text-elements-should-have-a-reasonable-contrast-ratio', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.mainRoleOnInappropriateElement = {
	name: 'mainRoleOnInappropriateElement', heading: 'role=main should only appear on significant elements', url: '', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.elementsWithMeaningfulBackgroundImage = {
	name: 'elementsWithMeaningfulBackgroundImage', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.pageWithoutTitle = {
	name: 'pageWithoutTitle', heading: 'The web page should have a title that describes topic or purpose', url: '', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.videoWithoutCaptions = {
	name: 'videoWithoutCaptions', heading: 'Video elements should use <track> elements to provide captions', url: 'https://github.com/GoogleChrome/accessibility-developer-tools/wiki/Audit-Rules#-ax_video_01--video-elements-should-use-track-elements-to-provide-captions', severity: axs.constants.Severity.WARNING, relevantElementMatcher: function (a) {
