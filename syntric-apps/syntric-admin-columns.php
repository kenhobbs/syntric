<?php
	...
	if( function_exists( 'ac_register_columns' ) ) {
		//add_action( 'init', 'syntric_admin_columns' );
		function syntric_admin_columns() {
			...
			ac_register_columns( 'syntric_calendar', [
				[
					'columns' => [
						'title'         => [
							'type'       => 'title',
						...
						'5ac1c5d9d14df' => [
							...
							'width'        => '150',
							'width_unit'   => 'px',
							'field'        => 'syntric_calendar_last_sync',
							'field_type'   => 'date',
							'date_format'  => 'diff',
							'before'       => '',
							'after'        => '',
			...
			ac_register_columns( 'syntric_event', [
				[
					'columns' => [
						'title'         => [
							'type'       => 'title',
						...
						'5ac1c6c331e6b' => [
							...
							'width'                 => '',
							'width_unit'            => '%',
							'field'                 => 'syntric_event_calendar_id',
	 ...
	 */
	add_action( 'acp/editing/saved', 'syntric_admin_columns_inline_save', 10, 3 );
	function syntric_admin_columns_inline_save( $column, $id, $value ) {
		$field_key        = $column -> get_option( 'field' );
		$is_teacher_field = get_field_object( 'syntric_user_is_teacher', 'user_' . $id );
		if( $is_teacher_field[ 'key' ] == $field_key ) {
			syntric_do_teacher_page( $id );
		}
	}
	 ...
	 */
	/*add_filter( 'acp/editing/save', 'syntric_admin_columns_save', 10, 5 );
	//add_filter( 'acp/editing/save/{$column_type}', 'my_acp_editing_save_value', 10, 5 );
	function syntric_admin_columns_save( $result, $column, $object_id, $value ) {
